...
This will download the entire `git-tutorial` repo to your project's directory.
...
We'd recommend to name it something that relevant to your changes (i.e. `add/your-id`)
